...
namespace TvDatabase
{
  ...
  public class Schedule : Persistent
  {
    ...
    private int seriesStartRangeOffsetInMinutes = 120;
    ...
    /// </summary>
    public int SeriesStartRangeOffsetInMinutes
    {
      get { return seriesStartRangeOffsetInMinutes;  }
      set
      {
        isChanged |= seriesStartRangeOffsetInMinutes != value;
        seriesStartRangeOffsetInMinutes = value;
      }
    }
    ...
    public bool IsSeriesStartRangeEnabled()
    {
      switch ((ScheduleRecordingType)this.ScheduleType)
      {
        ...
        case ScheduleRecordingType.WeeklyEveryTimeOnThisChannel:
          ...
          return SeriesStartRangeOffsetInMinutes > 0;
    ...
    public bool IsInsideSeriesStartRange(DateTime currentTime)
    {
      ...
      var startRange = this.startTime.AddMinutes(-SeriesStartRangeOffsetInMinutes);
      var endRange = this.startTime.AddMinutes(SeriesStartRangeOffsetInMinutes);
